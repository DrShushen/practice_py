...
Prerequisite (see https://stackoverflow.com/q/36088409):
```sh
sudo apt-get install redis-server
sudo service redis-server start
```

Run this app with `python app18.py`
"""
...
if __name__ == '__main__':
    app.run_server(debug=True, threaded=False, processes=6)  # NOTE: https://github.com/plotly/dash-recipes/issues/6
